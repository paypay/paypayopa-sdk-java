...
public class ApiConstants {
    ...
    public static final String DEFAULT_BASE_PATH = "https://apigw.sandbox.paypay.ne.jp";
    public static final String PROD_BASE_PATH = "https://apigw.paypay.ne.jp";
    public static final String SANDBOX_BASE_PATH = "https://apigw.sandbox.paypay.ne.jp";
    public static final String PERF_BASE_PATH = "https://perf-apigw.paypay.ne.jp";
